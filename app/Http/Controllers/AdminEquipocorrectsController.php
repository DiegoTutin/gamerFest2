<?php namespace App\Http\Controllers;
	...
	class AdminEquipocorrectsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "equipocorrects";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"NOMBRE","name"=>"nombre"];
			$this->col[] = ["label"=>"OBSERVACIONES","name"=>"observacion"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'NOMBRE','name'=>'nombre','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'OBSERVACIONES','name'=>'observacion','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
