<?php namespace App\Http\Controllers;
	...
	class AdminAulasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"EDIFICIO","name"=>"edificio"];
			...
			$this->form[] = ['label'=>'EDIFICIO','name'=>'edificio','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Edificio","name"=>"edificio","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
